...
<?php else: ?>
    ...
    <div class="container">
        ...
        > <a href='index.php'>Vorlesungen</a> > <a href='index.php'>Vorlesungsname</a> > Auswertung zu Voting XY
        </div>";
        ?>
    ...
    <div class='col-md-10'>";
            ...
            echo "<h3>" . $eintrag['text'] . " (" . $anzahlTeilnehmer['COUNT(*)'] . " Teilnehmer)"."   <button href='index.php' target='_blank' type='submit'' name='beamen'' class='btn btn-success'>Beam me up!</button></h3></br>";
